...
def fit_poisson_mixture_vb(
    ...
    return optimize_restarts(
        fit,
        lambda: initialize_poisson_mixture_variational_params(
            inputs,
            setting,
            init_log_std=fit.posterior_init_log_std,
        ),
        lambda noise_tree: lambda q: poisson_mixture_variational_elbo(
            q,
            inputs,
            noise_tree,
        ...
        lambda variational_params, history, converged: _build_poisson_variational_result(
